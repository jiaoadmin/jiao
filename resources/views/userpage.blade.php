...
<body class="g-acc-bg">
    ...
    <div class="sub_nav marginB person-page-menu">
        ...
        <a href="javascript:;"><s class="m_s7"></s>绑定微信<i></i></a>
