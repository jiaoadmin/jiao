...
<head>
    ...
    <script type="text/javascript" src="{{url('https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js')}}"></script>
    <script type="text/javascript"src="{{url('https://cdn.bootcss.com/blueimp-md5/2.10.0/js/md5.min.js')}}"></script>
        ...
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="{{url('admin/labellist')}}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加标签</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="{{url('admin/labeltable')}}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>标签展示</cite>
                        </a>
                    </li >
                    <li>
                        <a _href="{{url('admin/openidlist')}}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户标签设置</cite>
                        </a>
                    </li >
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src="{{url('admin/welocome')}}" frameborder="0" scrolling="yes" class="x-iframe"></iframe><!-- ./welcome.html -->
            </div>
        </div>
        <div id="tab_show"></div>
    </div>
...
<script>
    ...
    (function() {
        ...
        hm.src = "{{url('https://hm.baidu.com/hm.js?b393d153aeb26b46e9431fabaf0f6190')}}";
